...
class DateTimeMonthUtils {
	 ...
	 * @return int
	 */
	public static function days ($month, $isLeapYear = false) {
		if ($isLeapYear === null) {
			$isLeapYear = false;
		}
		if ($month === 1) {
	 ...
	 * @return int
	 */
	public static function getMonth ($days, $isLeapYear = false) {
		if ($isLeapYear === null) {
			$isLeapYear = false;
		}
		if ($days < 32) {
	 ...
	 * @return int
	 */
	public static function getMonthDay ($days, $isLeapYear = false) {
		if ($isLeapYear === null) {
			$isLeapYear = false;
		}
		if ($days < 32) {
	 ...
	 * @return int
	 */
	public static function toSeconds ($month, $isLeapYear = false) {
		if ($isLeapYear === null) {
			$isLeapYear = false;
		}
...
Boot::registerClass(DateTimeMonthUtils::class, 'datetime.utils.DateTimeMonthUtils');
