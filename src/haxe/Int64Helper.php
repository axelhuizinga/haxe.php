	...
	public static function fromFloat ($f) {
		...
		while ($rest >= 1) {
			...
			if ($curr >= 1) {
				...
				$b1 = null;
				if ($b === 0) {
					$this2 = new ___Int64($a_high, $a_low);
					$b1 = $this2;
				} else if ($b < 32) {
					$this3 = new ___Int64((((($a_high << $b << Int32_Impl_::$extraBits) >> Int32_Impl_::$extraBits) | Boot::shiftRightUnsigned($a_low, (32 - $b))) << Int32_Impl_::$extraBits) >> Int32_Impl_::$extraBits, ($a_low << $b << Int32_Impl_::$extraBits) >> Int32_Impl_::$extraBits);
					$b1 = $this3;
				} else {
					$this4 = new ___Int64(($a_low << ($b - 32) << Int32_Impl_::$extraBits) >> Int32_Impl_::$extraBits, 0);
					$b1 = $this4;
				}
		...
		if ($neg) {
			...
			$low1 = ((~$result->low + 1) << Int32_Impl_::$extraBits) >> Int32_Impl_::$extraBits;
			if ($low1 === 0) {
				$ret1 = $high1++;
