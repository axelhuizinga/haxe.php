...
class ExprDef extends HxEnum {
	 ...
	 * 
	 * @param object $e
	 * @param DisplayKind $displayKind
	 * 
	 * @return ExprDef
	 */
	static public function EDisplay ($e, $displayKind) {
		return new ExprDef('EDisplay', 24, [$e, $displayKind]);
	}
	 ...
	 * @return ExprDef
	 */
	static public function EFunction ($kind, $f) {
		return new ExprDef('EFunction', 11, [$kind, $f]);
	}
