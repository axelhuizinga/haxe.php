...
class TypeDefKind extends HxEnum {
	 ...
	 * @return TypeDefKind
	 */
	static public function TDClass ($superClass = null, $interfaces = null, $isInterface = null, $isFinal = null) {
		return new TypeDefKind('TDClass', 2, [$superClass, $interfaces, $isInterface, $isFinal]);
	}
